...
class Module extends Common
{
    ...
    public function index(){
        $list = $this->dao->order('listorder desc')->select();
    ...
    public function listOrder(){
        ...
        $result = ['msg' => '排序成功！','url'=>url('field',array('id'=>input('post.id'))), 'code' => '1'];
        return $result;
    }
    function fieldDel() {
        $id=input('id');
    ...
    public function get_tablesql($info,$do){
        ...
        switch($fieldtype) {
            ...
            case 'title':
                ...
                $sql[] = "ALTER TABLE `$tablename` $do `$field` VARCHAR( $maxlength ) NOT NULL DEFAULT '$default'";
                if($do=='add'){
                    $sql[] = "ALTER TABLE `$tablename` $do `title_style` VARCHAR( 225 ) NOT NULL DEFAULT ''";
