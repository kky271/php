<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"E:\phpStudy\WWW\cltphp/app/home\view\article-list.html";i:1498030112;s:53:"E:\phpStudy\WWW\cltphp/app/home\view\common-head.html";i:1498035173;s:55:"E:\phpStudy\WWW\cltphp/app/home\view\common-footer.html";i:1497948115;}*/ ?>
<!DOCTYPE html>
...
<section id="breadcrumb-wrapper">
    <div id="breadcrumb-content">
        <ul>
            ...
            <!--<li><a href="<?php echo url('index',array('catId'=>input('catId'))); ?>"><?php echo $title; ?></a></li>-->
        </ul>
    </div>
</section>
<!-- breadcrumb end here -->
        ...
        <div class="eight columns">
            <aside>
                <ul class="popular-list">
                    ...
                    <li>
                        <a href="<?php echo url('info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>">
                            <img src="<?php echo $vo['title_thumb']; ?>" alt="" class="img-border" />
                        </a>
                        <p class="popular-title">
                            <a href="<?php echo url('info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" style="<?php echo $vo['title_color']; ?>;<?php echo $vo['title_weight']; ?>"><?php echo $vo['title']; ?></a>
                        </p>
                        <p class="popular-title"></p>
                        <p class="comment-count"><a href="<?php echo url('info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>"><?php echo $vo['hits']; ?></a></p>
        ...
        <div class="four columns">
            <aside>
                ...
                <ul class="sidebar-list">
                    ...
                    <li><a href="<?php echo url($vo['controller'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" style="<?php echo $vo['title_color']; ?>;<?php echo $vo['title_weight']; ?>"><?php echo $vo['title']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </aside>
        </div>
