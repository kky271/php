<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"E:\phpStudy\WWW\cltphp/app/admin\view\login\login.html";i:1498033591;}*/ ?>
<!DOCTYPE html>
<html lang="zh_cn">
<head>
    <meta charset="utf-8">
...
<div class="beg-login-box" ng-app="hd" ng-controller="ctrl">
    ...
    <div class="beg-login-main">
        <form class="layui-form layui-form-pane" method="post">
            ...
            <textarea name="data" hidden></textarea><br>
            <div class="layui-form-item">
    ...
    <footer>
        <p>CLTPHP © <?php echo config('url_domain_root'); ?></p>
    </footer>
</div>
...
<script>
    ...
    m.controller('ctrl',['$scope','$http',function($scope,$http){
        $scope.field = {username:"admin",password:"admin123"};
