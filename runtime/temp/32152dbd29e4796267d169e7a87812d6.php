<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"E:\phpStudy\WWW\cltphp/app/admin\view\index\index.html";i:1497343748;s:54:"E:\phpStudy\WWW\cltphp/app/admin\view\common\head.html";i:1495509171;s:54:"E:\phpStudy\WWW\cltphp/app/admin\view\common\foot.html";i:1495508905;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title><?php echo lang('webName'); ?>后台管理</title>
    ...
    <div class="layui-main">
        <div class="admin-login-box">
            <a class="logo" style="left: 0;" href="<?php echo url('admin/index/index'); ?>">
                <span style="font-size: 22px;"><?php echo lang('webName'); ?></span>
            </a>
        ...
        <ul class="layui-nav admin-header-item">
            ...
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;"><i class="fa fa-user-circle" aria-hidden="true"></i><?php echo lang('adminInfo'); ?></a>
                    </dd>
                    <dd>
