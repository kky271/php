<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"E:\phpStudy\WWW\cltphp/app/home\view\article-show.html";i:1497944051;s:53:"E:\phpStudy\WWW\cltphp/app/home\view\common-head.html";i:1498035173;s:55:"E:\phpStudy\WWW\cltphp/app/home\view\common-footer.html";i:1497948115;}*/ ?>
<!DOCTYPE html>
...
<section id="content-wrapper">
    <div class="row">
        <div class="eight columns">
            <!-- blog post 1 -->
            <div class="blog-post">
                <img src="<?php echo $info['pic']; ?>" alt="blog-img" />
                <div class="post-info">
                    <div class="big-date"><?php echo toDate($info['createtime'],'d'); ?></div>
                    <div class="small-month"><?php echo toDate($info['createtime'],'Y/m'); ?></div>
                    <ul>
                        <li class="author-icon"><?php echo $info['username']; ?></li>
                        <li class="tag-icon"><a href="<?php echo $info['url']; ?>" target="_blank"><?php echo $info['copyfrom']; ?></a></li>
