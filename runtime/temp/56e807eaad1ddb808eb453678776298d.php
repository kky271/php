<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"E:\phpStudy\WWW\cltphp/app/admin\view\wechat\index.html";i:1496391805;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div style="margin: 15px;" ng-app="hd" ng-controller="ctrl">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" lay-verify="required" name="wxname" value="<?php echo $info['wxname']; ?>" placeholder="请输入公众号名称" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">原始ID</label>
            <div class="layui-input-4">
                <input type="text" name="wxid" value="<?php echo $info['wxid']; ?>" lay-verify="required" placeholder="请输入公众号原始ID" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="weixin" value="<?php echo $info['weixin']; ?>" lay-verify="required" placeholder="请输入微信号" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">AppID</label>
            <div class="layui-input-3">
                <input type="text" name="appid" value="<?php echo $info['appid']; ?>" lay-verify="required" placeholder="请输入AppID" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">AppSecret</label>
            <div class="layui-input-3">
                <input type="text" name="appsecret" value="<?php echo $info['appsecret']; ?>" lay-verify="required" placeholder="请输入AppSecret" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">Token</label>
            <div class="layui-input-3">
                <input type="text" name="w_token" value="<?php echo $info['w_token']; ?>" lay-verify="required" placeholder="请输入Token" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
