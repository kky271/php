<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:51:"E:\phpStudy\WWW\cltphp/app/home\view\page-show.html";i:1497941201;s:53:"E:\phpStudy\WWW\cltphp/app/home\view\common-head.html";i:1498035173;s:55:"E:\phpStudy\WWW\cltphp/app/home\view\common-footer.html";i:1497948115;}*/ ?>
<!DOCTYPE html>
...
<section id="content-wrapper">
    <div class="row">
        <div class="eight columns">
            <!-- blog post 1 -->
            <div class="blog-post">
                <img src="__HOME__/images/sample-images/blog-post1.jpg" alt="blog-img" />
                <div class="row">
                    <div class="columns">
                ...
                <ul class="popular-list">
                    ...
                    <li>
                        ...
                        <p class="popular-title">
                            <a href="<?php echo url($vo['controller'].'/info',array('id'=>$vo['id'],'catId'=>$vo['catid'])); ?>" style="<?php echo $vo['title_color']; ?>;<?php echo $vo['title_weight']; ?>"><?php echo $vo['title']; ?></a>
                        </p>
                        <p class="comment-count"><a href="single.html"><?php echo $vo['hits']; ?></a></p>
                        <p class="author-name"><?php echo $vo['username']; ?></p>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </aside>
